      ...
      <div className="vedioandpoints">
        <div className="points">
          <div className="add-pro">
            ...
            <p>
              Add details of the project you need to complete and the required
              skills, and get freelance offers in minutes.
            </p>
          </div>
          ...
          <div className="choose-bes-free">
            ...
            <p>
              The freelancer you choose will work on your project and follow up
              with you until you have the agreed work results and project
              delivery.
            </p>
          </div>
        </div>
